...
echo ""
echo "For local embeddings (node-client, cortex:import): set OLLAMA_BASE_URL (default http://localhost:11434)"
...
# Embedding models (used when OLLAMA_EMBEDDING_MODEL / OLLAMA_BASE_URL are set for node-client and cortex:import).
