...
- **Design:** `docs/workflows/ralph-design.md`. PRD attribute mapping (required / inferred / optional): `databases/cortex/README.md`. **Cross-repo:** See **Cross-repo usage** below.
