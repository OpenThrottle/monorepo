...
Options:
  ...
  ${COLORS.cyan}--prompt-file ${COLORS.gray}<path>${COLORS.reset}     Read layer-1 prompt text from UTF-8 file(s); repeat for persona + skills (mutually exclusive with ${COLORS.cyan}--prompt${COLORS.reset})
