...
- **api.local** (or **/api**) → `localhost:6010` (openthrottle-server: GraphQL, REST, Socket.IO). WebSocket is passed through by default.
- **developer.local** (or **/developer** and **/**) → `localhost:5173` (openthrottle-developer).
