...
- `Caddyfile` — one hostname per service (`api.local`→6021, `developer.local`→6020, `admin.local`→6022, `website.local`→6025, `ollama.local`→11434); requires `/etc/hosts` entries.
