...
import { AGENT_CONVERSATIONS_ACTION } from '~/routing/chat/hooks/useAgenticChatTurn';
...
/**
 * @description Owns the conversations-list state for the admin header switcher:
 ...
 * to the route-independent `/resources/agent-conversations` action.
 */
export function useConversationList(): UseConversationListResult {
  ...
  // Merge each loaded page into the accumulated list (append + dedup by id).
  React.useEffect(() => {
