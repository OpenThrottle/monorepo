...
export interface NativeBrowseProps {
  isAdding: boolean;
  isPicking: boolean;
  onClearPicked: () => void;
  onPickNative: () => void;
 ...
 */
export const NativeBrowse = (props: NativeBrowseProps): React.ReactElement => {
  const {
    isAdding,
    isPicking,
    onClearPicked,
  ...
  return (
    <div className="space-y-2" data-testid="NativeBrowse">
