...
export interface WorkspaceRepositoryDetailProps {
  editTo: string;
  repository: WorkspaceRepositoryFieldsFragment;
}

export const WorkspaceRepositoryDetail = (
  props: WorkspaceRepositoryDetailProps,
): React.ReactElement => {
  ...
  return (
    <div className="space-y-4" data-testid="WorkspaceRepositoryDetail">
      <Card>
              ...
              {checkouts.map((checkout) => {
                ...
                return (
                  <li
                    ...
                    data-testid={`WorkspaceRepositoryDetailCheckout-${checkout.id}`}
                    key={checkout.id}
                  >
