...
export interface WorkspaceCloneRepoDialogProps {
 ...
 * result renders in the shared WorkspaceAddFolderResult panel.
 */
export const WorkspaceCloneRepoDialog = (
  props: WorkspaceCloneRepoDialogProps,
): React.ReactElement => {
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      <DialogTrigger asChild={true}>
        <Button data-testid="WorkspaceCloneRepoDialogTrigger" variant="outline">
      ...
      <DialogContent
        ...
        data-testid="WorkspaceCloneRepoDialog"
      >
        <DialogHeader>
