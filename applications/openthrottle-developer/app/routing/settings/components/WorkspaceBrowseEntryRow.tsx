...
import type { WorkspaceBrowseEntry } from '~/routing/settings/hooks/useWorkspaceAddFolderDialog';

export interface WorkspaceBrowseEntryRowProps {
 ...
 */
export const WorkspaceBrowseEntryRow = (
  props: WorkspaceBrowseEntryRowProps,
): React.ReactElement => {
