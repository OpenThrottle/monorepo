...
import { WorkspaceRepositoryEditForm } from '../WorkspaceRepositoryEditForm';
import type { WorkspaceRepositoryEditFormProps } from '../WorkspaceRepositoryEditForm';
...
describe('WorkspaceRepositoryEditForm Component', () => {
  let component: RenderResult;
  let props: WorkspaceRepositoryEditFormProps;
  let submitted: Record<string, FormDataEntryValue | null>[];

  const setup = (): void => {
    const Component = () => <WorkspaceRepositoryEditForm {...props} />;
