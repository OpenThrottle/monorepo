...
import { WorkspaceAddFolderResult } from '../WorkspaceAddFolderResult';
import type { WorkspaceAddFolderResultProps } from '../WorkspaceAddFolderResult';
...
describe('WorkspaceAddFolderResult Component', () => {
  let component: RenderResult;
  let props: WorkspaceAddFolderResultProps;
  ...
  beforeEach(() => {
    ...
    const Component = () => <WorkspaceAddFolderResult {...props} />;
