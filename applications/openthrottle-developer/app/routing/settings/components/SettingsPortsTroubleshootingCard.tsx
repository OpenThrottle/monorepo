      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <p>
            ...
            reach the same openthrottle-server origin in typical local setups.
            If one is wrong you get{' '}
            <span className="font-medium text-foreground">
          ...
          <div>
            ...
            <ol className="list-inside list-decimal space-y-1.5">
              <li>
                ...
                <code className="text-xs">6021</code> — see services table in
                the monorepo doc).
              </li>
              <li>
              ...
              <li>
                Set <code className="text-xs">API_URL_INTERNAL</code> to an
                origin Node can reach from the Vite / SSR process (not always{' '}
          ...
          <div>
            ...
            <ul className="list-inside list-disc space-y-2">
              ...
              <li>
                ...
                open; WebSocket passthrough matters for Socket.IO.
              </li>
            </ul>
          </div>
