...
export interface WorkspaceAddFolderResultProps {
  payload: AddWorkspaceFolderMutation['addWorkspaceFolder'];
}

export const WorkspaceAddFolderResult = (
  props: WorkspaceAddFolderResultProps,
): React.ReactElement => {
  const { payload } = props;
  ...
  return (
    <Card data-testid="WorkspaceAddFolderResult">
      <CardHeader>
