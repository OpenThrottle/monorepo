...
import { WorkspaceBrowseEntryRow } from '~/routing/settings/components/WorkspaceBrowseEntryRow';
import type {
  WorkspaceBreadcrumbSegment,
  WorkspaceBrowseEntry,
} from '~/routing/settings/hooks/useWorkspaceAddFolderDialog';
 ...
 * list. Presentation for the useWorkspaceAddFolderDialog controller.
 */
export const WorkspaceDirectoryPicker = (
  props: WorkspaceDirectoryPickerProps,
): React.ReactElement => {
  const {
    breadcrumbs,
    browseError,
  ...
  return (
    <div
      ...
      data-testid="WorkspaceDirectoryPicker"
    >
