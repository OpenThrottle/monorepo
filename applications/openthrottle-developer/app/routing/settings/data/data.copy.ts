...
export const WORKSPACE_FOLDERS_COPY = {
  ...
  addFolderDescription: `Pick a repository discovered under your configured workspace roots. These are folders on the machine running openthrottle-server, not your browser.`,
  ...
  browseHint: `Browse inside your workspace roots when the folder is nested deeper than one level.`,
  ...
  discoveredEmpty: `No git repositories found under the configured workspace roots. Set OPENTHROTTLE_WORKSPACE_ROOTS on the server to enable discovery, or enter a path manually below.`,
