...
export const WORKSPACE_SETTINGS_COPY = {
  affiliateCtaAriaSuffix: ` (affiliate link, opens in a new tab)`,
  affiliateCtaPrefix: `Get `,
  affiliateDisclosure: `Some editor links above are affiliate/referral links. OpenThrottle may earn a commission if you sign up through them, at no extra cost to you.`,
  affiliatePromptPrefix: `Don’t have `,
  affiliatePromptSuffix: ` yet?`,
  ...
  presenceInstalledSrSuffix: `was detected on this machine`,
  presenceInstalledSuffix: `detected`,
  presenceNotFoundCaption: `Not detected? You can still enable it — its buttons will still appear.`,
  presenceNotFoundSrSuffix: `was not detected on this machine`,
  presenceNotFoundSuffix: `not detected`,
  presenceUnknownSrSuffix: `detection is unavailable`,
  presenceUnknownSuffix: `unknown`,
  presenceUntrustedNote: `OpenThrottle can’t inspect this machine from where the server is running, so no editor detection is being claimed here.`,
  ...
  targetsColumnEditors: `Editors`,
  targetsColumnPath: `Filesystem path`,
  targetsColumnRepository: `Repository`,
  targetsEmptyTitle: `Nothing to configure yet`,
...
export const WORKSPACE_REPOSITORY_DETAIL_COPY = {
  ...
  identitySectionDescription: `How this repository is labelled and which branch it defaults to.`,
  ...
  integrationSectionDescription: `Connect this repository to the rest of OpenThrottle.`,
...
export const ROLLOUT_COPY = {
  ...
  deleteConfirmDescriptionPrefix: `Delete`,
