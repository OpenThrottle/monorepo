import { buildDocsNav, flattenDocsNav } from '@openthrottle/react-router-docs';
...
/** Flattened prev/next ordering derived from {@link docsNav}. */
export const docsSequence = flattenDocsNav(docsNav);
