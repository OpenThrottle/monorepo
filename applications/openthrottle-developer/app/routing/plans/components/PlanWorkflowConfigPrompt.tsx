  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground text-xs">
        ...
        <code className="text-xs">--prompt-file</code>) are mutually exclusive,
        same as{' '}
      ...
      <div className="space-y-2">
        ...
        >
          ...
          do not pass CLI flags. <code className="text-xs">--prompt-stdin</code>{' '}
          is CLI-only (pipe stdin); use a terminal for that mode.
        </p>
      </div>
      ...
      {promptLayer === 'named' ? (
        ...
        <div className="space-y-2">
          ...
          >
            Repo-relative or absolute path; empty omits the flag (defaults come
            from env / .workflow-ralph.json).
          </p>
        </div>
      )}
    </fieldset>
