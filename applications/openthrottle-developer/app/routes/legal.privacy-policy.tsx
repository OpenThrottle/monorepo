      ...
      <div>
        ...
        <div className="text-muted-foreground max-w-3xl space-y-4 text-sm md:space-y-8">
          <p>
            ...
            Matthew Scholta, and you are using its Developer application.
            ...
            visit, and how that information is used. OpenThrottle is provided as
            is, and this policy may evolve as the product evolves.
          </p>
          ...
          <p>
            ...
            required to browse OpenThrottle. It does not ask for your name,
          ...
          <p>
            OpenThrottle uses a minimal set of cookies and browser local storage
            to remember preferences such as theme selection and to keep the
            ...
            from your browser settings; the application will continue to
          ...
          <p>
            ...
            hosting and content delivery provider that serves OpenThrottle, and,
            ...
            policies. Following an external link is treated as leaving
            OpenThrottle.
          </p>
          ...
          <p>
            ...
            deleted by the underlying providers. Because OpenThrottle does not
          ...
          <p>
            OpenThrottle is not directed to children under the age of 13, and it
            ...
            application, please get in touch so it can be removed.
          </p>
          ...
          <p>
            ...
            OpenThrottle, the tools it uses, or applicable best practices.
            Updates take effect when published on this page. Continued use of
