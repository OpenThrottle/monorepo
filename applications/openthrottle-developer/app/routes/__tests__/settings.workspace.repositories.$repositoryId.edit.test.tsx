...
import Component from '../settings.workspace.repositories.$repositoryId.edit';
...
describe('routes/settings.workspace.repositories.$repositoryId.edit.tsx', () => {
  test('renders the repository edit form', () => {
    ...
    expect(view.getByTestId('WorkspaceRepositoryEditForm')).toBeInTheDocument();
