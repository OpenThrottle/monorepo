...
/**
 * Candidate voice for the bake-off: "Brian", a deep US-male premade narration
 * voice. Pinned so takes are reproducible — change only via a new bake-off.
 */
export const DEFAULT_ELEVENLABS_VOICE = 'nPczCjzI2devNBz1zQrb';

/** Quality-tier model, pinned for reproducibility and recorded per take. */
export const DEFAULT_ELEVENLABS_MODEL = 'eleven_multilingual_v2';

const KEY_HINT =
  'Set ELEVENLABS_API_KEY in the repo root .env and export it before running (set -a; source .env; set +a). See applications/openthrottle-developer/tests/demo/NARRATION.md';
