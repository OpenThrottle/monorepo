...
```bash
node applications/openthrottle-developer/tests/demo/spike/recorder-b-playwright.mjs --cdp
```

Then assemble and inspect:

```bash
cd applications/openthrottle-developer/tests/demo/spike/output/b-cdp
