...
type Module = typeof import("../_layout.mail.inbox.$id.js")

type Info = GetInfo<{
  file: "routes/_layout.mail.inbox.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_layout.mail.js");
}, {
  id: "routes/_layout.mail.inbox.$id";
  module: typeof import("../_layout.mail.inbox.$id.js");
}];
