...
// 🚧 One-time boot banner (fires at server module load). openthrottle-email is
// an experimental preview — see the Project status table in the root README.
logger.warn(
  [
    '',
    '🚧  openthrottle-email — EXPERIMENTAL preview',
