...
/**
 * @description Minimal interface for the injectable emitter. The consuming
 * app provides a provider that implements this (e.g. maps event names to
 * emitPlanUpdated/emitTaskCompleted or implements a single emit(event, payload)).
 */
