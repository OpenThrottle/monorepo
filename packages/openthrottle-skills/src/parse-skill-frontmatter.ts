...
export interface ParsedSkillFrontmatter {
  /**
   * Typed argument declarations from `metadata.arguments`, or
...
/**
 * @description Parses `name`, `description`, optional `disable-model-invocation`, optional `tags`, and optional typed `arguments` (from `metadata.arguments`) from SKILL.md frontmatter. Provenance is NOT frontmatter — it is derived from the skill-sync layout (see `walk-agent-assets-on-disk.ts` and `parse-skills-lock.ts`).
 * @public
 */
