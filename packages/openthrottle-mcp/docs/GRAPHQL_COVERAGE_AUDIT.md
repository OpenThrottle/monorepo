...
Audit of operations needed for notes, plans, projects, tasks, commit, activity, output, search, and health so openthrottle-mcp can achieve parity with ai-mcp over GraphQL only (no direct Cortex Postgres).
