...
/**
 * @description Sets the global reporter for profile execution results.
 * Used by file writer or other consumers.
 */
 ...
 */
export function notifyProfileExecutionReporter(
