...
React Router providers, hooks, and UI for OpenThrottle in-app notifications: Socket.IO client wiring, store context, bell and list components, and browser permission flows.
