 ...
 * GraphQL-first workflow layer so no cortex surface is missed.
 *
 ...
 *
 * ## Queries / mutations (alphabetical by cortex helper)
 *
 ...
 *
 * ## Related workflow bins (same cortex module)
 *
...
export const CORTEX_RALPH_PARITY_NOTE =
  'See cortex-ralph-parity.ts for cortex-ralph ↔ GraphQL operation mapping.';
