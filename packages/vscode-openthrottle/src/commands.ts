/**
 * @description Registers OpenThrottle commands: create-plan-from-text, refresh. Uses config and client.
 */
...
/**
 * @description Run the create-plan-from-text flow: input box → optional category pick → createPlan mutation → refresh tree.
 */
async function runCreatePlanFromText(
