...
- Verify **LICENSE consistency** — root `LICENSE.md` (Standard EULA) and per-package `LICENSE.md` files generated by templates
...
- [LICENSE.md](../../LICENSE.md) — Standard EULA (root and generated package copies); proprietary, evaluation-only grant, commercial use requires a separate agreement
