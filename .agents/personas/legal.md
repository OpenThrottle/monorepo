...
- Verify **LICENSE consistency** — root `LICENSE.md` (MIT) and per-package `LICENSE.md` files generated by templates
...
- [LICENSE.md](../../LICENSE.md) — MIT license (root and generated package copies)
