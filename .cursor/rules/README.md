...
- **Generators first:** Before writing new code, components, or services, check for and use `@tools/generators` generators. See [personal-generators.mdc](./personal-generators.mdc) and [docs/tools/generators/AGENT_USAGE.md](../../docs/tools/generators/AGENT_USAGE.md).
