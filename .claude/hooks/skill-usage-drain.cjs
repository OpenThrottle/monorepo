...
var bufferPath = (repoRoot, leaf) => resolveRepoProfile(repoRoot) === REPO_PROFILES.FOREIGN ? import_node_path3.default.join(foreignStateDir(repoRoot), leaf) : import_node_path3.default.join(repoRoot, BUFFER_DIR_REL, leaf);
