...
| **GraphQL auth**      | `OPENTHROTTLE_WORKFLOWS_AUTH_TOKEN`, `MCP_DEVELOPER_AUTH_TOKEN`, `OPENTHROTTLE_WORKER_GRAPHQL_AUTH_TOKEN`, `OPENTHROTTLE_WORKER_GRAPHQL_PLACEHOLDER_TOKEN` | Secrets                             |
