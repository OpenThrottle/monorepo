...
- **Plan-centric (default):** `workflow-ralph --plan <plan-uuid>`. No ref file is written during the run. The agent receives Plan-Id in the prompt and loads plan/tasks via OT MCP. When OpenThrottle is available, the CLI sets the plan to `IN_PROGRESS` at run start.
...
## Single workflow (Cortex only)

| Step     | What happens                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Input    | Idea, PRD (JSON/Markdown), or existing OT plan ID. If rough → planning mode or MCP to create plan + tasks.                                                                                                                                                                                                                                                                                                                                                                               |
| Plan     | Plan and tasks live in Cortex. Load via `get_plan(id)`, `get_tasks_by_plan_id(planId)`. In task-centric mode, load via `get_task(taskId)` and use `planId` from the task.                                                                                                                                                                                                                                                                                                                |
...
The CLI sets the plan to `IN_PROGRESS` at run start when Cortex is configured (plan- and task-centric). Remaining limitation:
