...
| **@openthrottle/mcp**        | Plans/tasks MCP server (Cortex knowledge base: plans, tasks, semantic search, activity).             | `@openthrottle/ai-mcp` (packages/mattscholta/ai-mcp).                     | Yes                      |
| **@openthrottle/docs-mcp**   | Documentation search MCP server.                                                                     | `@cortex/docs-mcp` (packages/cortex/docs-mcp).                           | Yes                      |
| **@openthrottle/vscode**     | VS Code (and compatible hosts) extension.                                                            | `vscode-openthrottle` (packages/openthrottle/vscode-openthrottle).       | Yes                      |
