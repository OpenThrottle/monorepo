...
Plans can target arbitrary local project directories instead of the monorepo root. This is useful when you want Ralph to work against a different checkout (e.g. `/Users/matt/Development/github/shiftsmart/services/native-apps`).
