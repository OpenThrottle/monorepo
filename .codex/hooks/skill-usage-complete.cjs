 ...
 * Source: packages/agentic-hooks/src/adapters/codex/complete.ts
...
// packages/agentic-hooks/src/adapters/codex/complete.ts
...
var normalizeCodexSessionEndPayload = (raw) => {
