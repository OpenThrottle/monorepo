...
Important: `$planId` is the first (and only) argument passed to this prompt. If that value does not map back to a OpenThrottle Plan or Task ID, throw an error immediately!
