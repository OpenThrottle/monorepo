...
## Post-merge work ledger

Mechanics are injected. Two things they omit:

- **One-shot CLI:** `pnpm exec workflow-link-merge --plan <uuid> --sha <squash-sha> --repo <owner/repo> [--task <uuid>] [--message <msg>]`.
