...
description: >-
  ...
  Plan-Id/Task-Id, then open a PR. USE WHEN the user runs /ot-plan-loop <planId>,
...
2. **Open a PR** with `/github-pull-request` (conventional-commit title, the repo PR template, testing steps phrased as things to do). Report the PR link back to the user.
